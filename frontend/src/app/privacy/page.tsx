        ...
        <div className="max-w-4xl mx-auto">
            ...
            {sections.map((section, index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="text-primary-400 mr-4">{section.icon}</div>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              Dados (LGPD) e as melhores práticas internacionais de privacidade.
              Mantemos registros detalhados de todas as atividades de tratamento
              de dados.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Qualquer alteração nesta política será comunicada com antecedência
              através do email cadastrado ou aviso no site. Recomendamos a
              verificação periódica desta página.
            </p>
          </motion.div>
