...
declare global {
  namespace Express {
    interface Response {
      ...
      sendPaginated<T>(data: T[], pagination: PaginationMeta, message?: string): Response;
...
export class ResponseHandlerMiddleware {
  ...
  public static handler(req: Request, res: Response, next: NextFunction): void {
    ...
    res.sendError = function(message: string, statusCode: number = 400, errors?: any): Response {
    ...
    // Resposta paginada
    res.sendPaginated = function<T>(data: T[], pagination: PaginationMeta, message?: string): Response {
    ...
    res.sendUnauthorized = function(message: string = 'Unauthorized'): Response {
    ...
    res.sendValidationError = function(errors: any[], message: string = 'Validation failed'): Response {
   ...
   */
  public static corsHeaders(req: Request, res: Response, next: NextFunction): void {
   ...
   */
  public static addMetadata(req: Request, res: Response, next: NextFunction): void {
